...
const CitizenshipCategories = {
    ...
    // Άρθρο 10 - Πολιτογράφηση ομογενών στο εξωτερικό
    NATURALIZATION_EXPATRIATE: {
        id: 'naturalization_expatriate',
        name: 'Πολιτογράφηση Ομογενών Εξωτερικού (Άρθρο 10)',
        article: 'Άρθρο 10 Ν. 3284/2004',
        legalText: 'Αλλοδαπός ομογενής που διαμένει μόνιμα στο εξωτερικό μπορεί να πολιτογραφηθεί Έλληνας με απόδειξη ελληνικής καταγωγής και εθνικής συνείδησης μέσω προξενείου.',
        description: 'Ομογενείς που διαμένουν ΜΟΝΙΜΑ στο εξωτερικό - διαδικασία μέσω προξενείων.',
        icon: '🌍',
        cost: { min: 700, max: 900, currency: '€', description: 'Παράβολο 700€ + έξοδα + προξενικά τέλη' },
        estimatedTime: '18-36 μήνες',
        source: 'Άρθρο 10 Ν. 3284/2004, mitos.gov.gr'
    },
    // Άρθρο 11 - Ανήλικα και άγαμα τέκνα πολιτογραφούμενων
    NATURALIZATION_CHILDREN: {
        id: 'naturalization_children',
        name: 'Πολιτογράφηση Τέκνων με Γονέα (Άρθρο 11)',
        article: 'Άρθρο 11 Ν. 3284/2004',
        legalText: 'Ανήλικα και άγαμα ενήλικα τέκνα πολιτογραφούμενου αποκτούν ελληνική ιθαγένεια με τον γονέα.',
        description: 'Τέκνα πολιτογραφούμενου γονέα - αυτόματη ή με δήλωση.',
        icon: '👨‍👩‍👧‍👦',
        cost: { min: 50, max: 150, currency: '€', description: 'Έξοδα πιστοποιητικών + δήλωση (για ενήλικα)' },
        estimatedTime: '3-6 μήνες',
        source: 'Άρθρο 11 Ν. 3284/2004'
    },
    // Άρθρο 5 παρ. 2ε - EU citizens
    NATURALIZATION_EU_CITIZEN: {
        id: 'naturalization_eu_citizen',
        name: 'Πολιτογράφηση Πολίτη ΕΕ',
        article: 'Άρθρο 5 παρ. 2(ε) Ν. 3284/2004',
        legalText: 'Ο χρόνος νόμιμης διαμονής μειώνεται σε τρία (3) έτη για πολίτες κρατών-μελών της Ε.Ε.',
        description: 'Πολίτες ΕΕ με μειωμένη απαίτηση διαμονής (3 έτη).',
        icon: '🇪🇺',
        cost: { min: 550, max: 700, currency: '€', description: 'Παράβολο 550€ + Π.Ε.Γ.Π. 100€' },
        estimatedTime: '12-18 μήνες',
        source: 'Άρθρο 5 Ν. 3284/2004'
    },
    // Άρθρο 5 παρ. 2στ - University graduates
    NATURALIZATION_UNIVERSITY_GRAD: {
        id: 'naturalization_university_grad',
        name: 'Πολιτογράφηση Απόφοιτου Πανεπιστημίου',
        article: 'Άρθρο 5 παρ. 2(στ) Ν. 3284/2004',
        legalText: 'Ο χρόνος μειώνεται σε τρία (3) έτη για απόφοιτους ελληνικών ΑΕΙ ή ΤΕΙ.',
        description: 'Απόφοιτοι ελληνικών πανεπιστημίων με μειωμένη απαίτηση.',
        icon: '🎓',
        cost: { min: 550, max: 700, currency: '€', description: 'Παράβολο 550€ + Π.Ε.Γ.Π. 100€' },
        estimatedTime: '12-18 μήνες',
        source: 'Άρθρο 5 Ν. 3284/2004'
